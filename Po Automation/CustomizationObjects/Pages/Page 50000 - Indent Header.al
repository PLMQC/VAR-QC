            ...
            group("F&unctions")
            {
                ...
                action("Close Indent")
                {
                    ...
                    begin
                        IndentLine.Reset();
                        IndentLine.SetRange("Document No.", Rec."No.");
                        IndentLine.SetRange("Indent Status", Rec."Indent Status");
                        //IndentLine.SetRange("Shortcut Dimension 1 Code_B2B", Rec."Shortcut Dimension 1 Code_B2B");
                        //IndentLine.SetRange("Shortcut Dimension 2 Code_B2B", Rec."Shortcut Dimension 2 Code_B2B");
                        //IndentLine.SetRange("Delivery Location", Rec."Delivery Location");
                        if IndentLine.FindSet() then begin
                            repeat
                                PurchaseLine.Reset();
                                PurchaseLine.SetRange("Indent No.", IndentLine."Document No.");
                                PurchaseLine.SetRange("Indent Line No.", IndentLine."Line No.");
                                PurchaseLine.SetRange("Shortcut Dimension 1 Code", IndentLine."Shortcut Dimension 1 Code_B2B");
                                PurchaseLine.SetRange("Shortcut Dimension 2 Code", IndentLine."Shortcut Dimension 2 Code_B2B");
                                PurchaseLine.SetRange("Location Code", IndentLine."Delivery Location");
                                PurchaseLine.SetRange(Type, IndentLine.Type);
                                PurchaseLine.SetRange("No.", IndentLine."No.");
                                if PurchaseLine.FindSet() then begin
                                    repeat
                                        if PurchaseLine.Quantity >= IndentLine."Req.Quantity" then
                                            Rec."Indent Status" := Rec."Indent Status"::Close
                                        else
                                            Error('PO Qty is greater than Purchase Line Quantity');
