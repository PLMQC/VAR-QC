        ...
        IF IndentLine.FIND('-') THEN
            REPEAT
                ...
                END ELSE BEGIN
                    ...
                    CreateIndents."Material Type" := IndentLine.Type;//B2BJKon15May2023
    ...
    begin
        ...
        IF CreateIndents.FIND('-') THEN
            REPEAT
                ...
                IndentVendorItems."Material Type" := CreateIndents."Material Type"; //B2BJKon15May2023 >>
                //B2BJK <<
            ...
            REPEAT
                ...
                IF IndentVendorEnquiry.FIND('-') THEN BEGIN
                    ...
                    REPEAT
                        ...
                        //PurchaseLine.Type := PurchaseLine.Type::Item; ////Commented by B2BJKon15May2023
                        //B2BJKon15May2023 >>
                        if IndentVendorEnquiry."Material Type" = IndentVendorEnquiry."Material Type"::Item then
                            PurchaseLine.Type := PurchaseLine.Type::Item
                        else
                            if IndentVendorEnquiry."Material Type" = IndentVendorEnquiry."Material Type"::"G/L Account" then
                                PurchaseLine.Type := PurchaseLine.Type::"G/L Account"
                            else
                                if IndentVendorEnquiry."Material Type" = IndentVendorEnquiry."Material Type"::"Fixed Assets" then
                ...
                IF PurchaseLine.FIND('-') THEN
                    REPEAT
                        ...
                        if PurchaseLine.Type = PurchaseLine.Type::Item then
                            QuoteCompare."Material Type" := QuoteCompare."Material Type"::Item
                        else
                            if PurchaseLine.Type = PurchaseLine.Type::"G/L Account" then
                                QuoteCompare."Material Type" := QuoteCompare."Material Type"::"G/L Account"
                            else
                                if PurchaseLine.Type = PurchaseLine.Type::"Fixed Asset" then
                                    QuoteCompare."Material Type" := QuoteCompare."Material Type"::"Fixed Assets";
                        //B2BJKon15May2023 <<
                        PurchaseSetup.GET;
                ...
                IF Vend.GET(PurchaseHeader."Buy-from Vendor No.") AND (Vend.Blocked = Vend.Blocked::" ") THEN BEGIN
                    ...
                    IF PurchaseLine.FIND('-') THEN
                        REPEAT
                            ...
                            //B2BPROn08Aug2023>>>
                            QuoteCompare."Indent No." := PurchaseLine."Indent No.";
                            QuoteCompare."Indent Line No." := PurchaseLine."Line No.";
                            //B2BPROn08Aug2023<<<
                            QuoteCompare.INSERT();
                        UNTIL PurchaseLine.NEXT() = 0;
                END;
    ...
    begin
        ...
        IF PurchaseLine.FIND('-') THEN
            REPEAT
                ...
                //IF PurchaseLine.Type = PurchaseLine.Type::Item THEN BEGIN //Commented By B2BJKon15May2023 >>
                //  PurchaseLineQuote.Type := PurchaseLineQuote.Type::Item; //Commented By B2BJKon15May2023 >>
                //B2BJKon15May2023 >>
                PurchaseLineQuote.Validate(Type, PurchaseLine.Type);
                //B2BJKon15May2023 >>
    ...
    begin
        ...
        IF CreateIndents.FIND('-') THEN
            REPEAT
                ...
                //B2BJK <<
                //B2bJK on 15May2022 >>
                IndentVendorItems."Material Type" := CreateIndents."Material Type";
                //B2bJK on 15May2022 <<
                if IndentReqHdr.Get(CreateIndents."Document No.") then begin
                    IndentVendorItems."Shortcut Dimension 1 Code_B2B" := IndentReqHdr."Shortcut Dimension 1 Code_B2B";
                    IndentVendorItems."Shortcut Dimension 2 Code_B2B" := IndentReqHdr."Shortcut Dimension 2 Code_B2B";
